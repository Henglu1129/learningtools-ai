...
const Footer = () => {
  ...
  return (
    <footer className="relative flex h-[350px] md:h-[450px] w-full flex-col justify-between overflow-hidden bg-black">
      <canvas ref={canvasRef} className="absolute inset-0 h-full w-full pointer-events-none" />
      
      <div className="relative z-10 flex flex-col items-center justify-start pt-10 md:pt-14 flex-1">
        <div className="relative mule-run-title-wrapper">
          {/* White text layer (base) - using system fonts similar to reference */}
          <h2 
            className="text-5xl md:text-7xl lg:text-[110px] text-white tracking-tight select-none"
            style={{ 
        ...
        <div className="mt-4 md:mt-6 text-center text-white/70 text-sm md:text-base px-4">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 items-center px-4 md:px-10 pb-4 gap-3">
        <div className="flex flex-row justify-center md:justify-start gap-2">
          ...
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="white"><path d="M17.9309 2.53467H21.0935L14.1841 10.4317L22.3125 21.1778H15.948L10.9632 14.6603L5.25933 21.1778H2.09478L9.48509 12.731L1.6875 2.53467H8.21354L12.7194 8.49185L17.9309 2.53467ZM16.8209 19.2848H18.5734L7.26131 4.32823H5.38074L16.8209 19.2848Z"/></svg>
          </a>
          <a 
        ...
        <div className="flex items-center justify-center gap-6">
          <a 
            ...
            className="text-white text-xs underline hover:opacity-70 transition-opacity"
        ...
        <div className="text-white text-xs font-medium text-center md:text-right">MuleRun@2025</div>
      </div>
    </footer>
  );
};
