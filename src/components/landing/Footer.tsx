      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 items-center px-6 md:px-10 pb-6 gap-4">
        ...
        <div className="flex flex-row justify-center md:justify-start gap-2">
          ...
          <a 
            ...
            className="w-9 h-9 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors"
          >
            <svg className="w-6 h-6" viewBox="0 0 36 36" fill="white">
        ...
        <div className="flex items-center justify-center gap-6">
          <a 
            ...
            className="text-white text-sm underline hover:opacity-70 transition-opacity"
          >
            Terms
          </a>
          <a 
        ...
        {/* Copyright */}
        <div className="text-white text-sm font-medium text-center md:text-right">
          MuleRun@2025
        </div>
      </div>
    </footer>
