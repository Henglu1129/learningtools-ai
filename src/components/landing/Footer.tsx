  ...
  return (
    <footer className="bg-black py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
        {/* Title */}
        <h2 
          className="text-white/80 text-xl md:text-2xl lg:text-3xl tracking-wider mb-8 md:mb-12"
        ...
        <div className="flex items-center gap-6 md:gap-8 mb-8 md:mb-12">
          <a 
            ...
            className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity"
            onClick={() => trackClick(ANALYTICS_EVENTS.FOOTER_DISCORD)}
          >
            <svg className="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="black">
          ...
          >
            <svg className="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="black">
              <path d="M17.9309 2.53467H21.0935L14.1841 10.4317L22.3125 21.1778H15.948L10.9632 14.6603L5.25933 21.1778H2.09478L9.48509 12.731L1.6875 2.53467H8.21354L12.7194 8.49185L17.9309 2.53467ZM16.8209 19.2848H18.5734L7.26131 4.32823H5.38074L16.8209 19.2848Z"/>
            </svg>
          </a>
          <a 
          ...
          >
            <svg className="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 23 23" fill="black">
              <path d="M20.8345 0H1.66113C0.742676 0 0 0.725098 0 1.62158V20.874C0 21.7705 0.742676 22.5 1.66113 22.5H20.8345C21.7529 22.5 22.5 21.7705 22.5 20.8784V1.62158C22.5 0.725098 21.7529 0 20.8345 0ZM6.67529 19.1733H3.33545V8.4331H6.67529V19.1733ZM5.00537 6.96973C3.93311 6.96973 3.06738 6.104 3.06738 5.03613C3.06738 3.96826 3.93311 3.10254 5.00537 3.10254C6.07324 3.10254 6.93896 3.96826 6.93896 5.03613C6.93896 6.09961 6.07324 6.96973 5.00537 6.96973ZM19.1733 19.1733H15.8379V13.9526C15.8379 12.709 15.8159 11.105 14.1021 11.105C12.3662 11.105 12.1025 12.4629 12.1025 13.8647V19.1733H8.77149V8.4331H11.9707V9.90088H12.0146C12.4585 9.05713 13.5483 8.16504 15.1699 8.16504C18.5493 8.16504 19.1733 10.3887 19.1733 13.2803V19.1733Z"/>
            </svg>
          </a>
          <a 
        ...
        <div className="flex items-center gap-8 md:gap-12">
          <a 
            ...
            className="text-white/80 text-sm md:text-base underline hover:text-white transition-colors"
